...
if($_POST['action']=="insert") {
	...
	if(!$errors) {
		...
		$insertSql = "INSERT INTO `movie`
		              (`movie_name`,`movie_description`,`movie_genre`,`movie_release_date`,`movie_image_main`,`movie_image_thumb`) 
					  VALUES
					  ('{$movie_name}','{$movie_description}','{$movie_genre}','{$movie_release_date}','{$main}','{$thumb}')";
